...
<body style="background-color: #999999; margin-top: 3px; margin-left: 3px;">
	<table
					...
					<tr align="center" bgcolor="#eeeeee">
						...
						<td align="center" bgcolor="#eeeeee">
							<table cellpadding="3" cellspacing="0">
								<tr align="center">
									<td><font face="Courier New">《 Welcome <font
											color="#0066CC"><%=user.getNickname()%></font> 》</font></td>

									<td><a href="/upload.jsp" target="main">:: File upload</a>
									</td>

									<td><a href="/file_list.jsp" target="main">:: File
											listing</a></td>
					...
					<tr>
						<td>
							...
							%> <iframe width="100%" height="100%" frameborder="0"
								src="/file_list.jsp" name="main"> Your web browser
 ...
 %>
		...
		<td height="20" align="center" bgcolor="#99CC66"><font
